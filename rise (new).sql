...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 20, 2025 at 05:38 PM
...
CREATE TABLE `activity_log` (
  ...
  `coumn_name` varchar(100) NOT NULL,
  ...
  `created_at` datetime NOT NULL DEFAULT '2025-12-20 16:46:25',
  `added_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_by` varchar(50) DEFAULT NULL,
...
(6, 'hhhhhhhhhhhh', 1, 1, 1, 36, 2, 'F20250010006', '2025-12-20 10:10:52', '', '2025-12-20 11:01:50');
...
(1, 3, 36, '6', '', '2025-12-19 10:52:37', NULL, '2025-12-20 06:03:09', 0);
...
(3, 'Student', '[\"createFaculty\",\"updateFaculty\",\"viewFaculty\",\"deleteFaculty\",\"createStudentProfile\",\"updateStudentProfile\",\"viewStudentProfile\",\"deleteStudentProfile\",\"createFacultyProfile\",\"updateFacultyProfile\",\"viewFacultyProfile\",\"deleteFacultyProfile\",\"updateRole\",\"viewRole\",\"deleteRole\",\"createDepartment\",\"updateDepartment\",\"viewStudentDashboard\"]', '', '2025-12-17 09:27:04', '', '2025-12-20 10:47:54', 0),
(4, 'Teacher', '[\"createRole\",\"updateRole\",\"viewRole\",\"deleteRole\",\"createDepartment\",\"updateDepartment\",\"viewDepartment\",\"deleteDepartment\",\"viewFacultyDashboard\"]', '', '2025-12-17 09:27:04', '', '2025-12-20 07:06:01', 0),
...
(7, 'Iqac', '[\"createFeedback\",\"viewFeedback\",\"viewIqacDashboard\"]', '', '2025-12-18 09:50:44', '', '2025-12-20 07:01:14', 0);
...
(7, 'S20250010003', 3, 'NAGESH', 'TUKARAM', 'GAVADE', '457898654654', '$2y$10$PamPDZ2hsAETEIOo4B.uiO3ySj3SmeY5.ic.irEmZj.wKrLJSVTA6', '', '2025-12-20 05:57:06', '', '2025-12-20 05:57:06', 0),
(8, 'S20250010004', 3, 'MAYURI', 'DATTATRAY', 'GAIKWAD', '785214653554', '$2y$10$kIvtMGfPMIx2mHUsLAPnmuisCOipdJ1g1K5Rjccwr9IdPvLIVNANq', '', '2025-12-20 05:58:11', '', '2025-12-20 05:58:11', 0),
(9, 'S20250010005', 3, 'ARTI', 'ASHOK', 'CHANGAN', '785245632455', '$2y$10$tu6oQM47EARQL5j7k.ie5ugZK141F7eJ4lQADSyVHDg1TwcSXmVRe', '', '2025-12-20 06:03:09', '', '2025-12-20 06:03:09', 0);
...
--
ALTER TABLE `faculty_registration`
  MODIFY `faculty_registration_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `feedback_master`
--
ALTER TABLE `feedback_master`
  MODIFY `feedback_master_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `rise_number_counter`
  MODIFY `rise_number_counter_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `student_registration`
  MODIFY `student_registration_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
