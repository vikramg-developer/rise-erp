                    ...
                    <table id="responsiveDataTable" class="table table-bordered text-nowrap w-100">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Third Year</td>
                                <td>
                                    <a href="<?php echo base_url('i-card-print'); ?>" target="_blank" class="btn btn-warning mb-1" ><?= lang('App.bonafide'); ?> <?= lang('App.certificate'); ?></a>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">2</th>
                                ...
                                <td>Third Year</td>
                                <td>
                                    <a target="_blank" class="btn btn-warning mb-1" ><?= lang('App.bonafide'); ?> <?= lang('App.certificate'); ?></a>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">3</th>
