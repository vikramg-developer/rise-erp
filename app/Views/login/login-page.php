...
<?php endif; ?>
                    ...
                    <div class="row gy-3">
                        <div class="col-xl-12">
                            ...
                            <select class="form-control js-example-basic-single" name="user_type" id="user_type" required>
                        ...
                        <div class="col-xl-12">
                            ...
                            <input type="text" class="form-control form-control-lg" id="login_username" maxlength="13" minlength="13"name="login_username" placeholder="<?= lang('App.rise') ?> <?= lang('App.number') ?>"required>
                        </div>
                        <div class="col-xl-12">
                            ...
                            <div class="input-group">
                                <input type="password" class="form-control form-control-lg" id="signin-password" name="login_password"placeholder="<?= lang('App.password') ?>"required>
