                ...
                <div class="card-body p-5">
                    ...
                    <div class="row gy-3">
                        <div class="col-xl-12">
                            ...
                            <input type="text" class="form-control form-control-lg" id="login-username" name="login-username" placeholder="<?= lang('App.rise') ?> <?= lang('App.number') ?>">
                        </div>
                        <div class="col-xl-12">
                            ...
                            <div class="input-group">
                                <input type="password" class="form-control form-control-lg" id="signin-password" name="login-password" placeholder="<?= lang('App.password') ?>">
                        ...
                        <div class="mt-2">
                            <div class="form-check">
                                ...
                                <label class="form-check-label text-muted fw-normal" for="defaultCheck1">Forget password ?</label>
                            </div>
                        </div>
                    </div>
