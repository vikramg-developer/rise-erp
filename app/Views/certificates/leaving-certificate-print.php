...
<!--    <tr>
    ...
    <?php
//    if(count($duplicate_lc) < 2)
//    {
    ?>
    
    <p style="margin-top:-1%">Date: 09/12/2025<?php //echo date('d/m/Y',strtotime($lc[0]['add_dt'])); ?></p>
<!--    <br>
    <br>
    <br>-->
    ...
    <?php
//    }
//    else if(count($duplicate_lc) > 1)
//    {
    ?>
<!--    <p>Date: <?php //echo date('d/m/Y',strtotime($duplicate_lc[0]['add_dt'])); ?></p>
    <p>TC. No. 2: Date: <?php //echo date('d/m/Y',strtotime($lc[0]['add_dt'])); ?></p> -->
<!--    <br>
    <br>
    <br>-->    
    <?php // } ?>    
