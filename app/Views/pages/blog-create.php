                                    ...
                                    <div class="card-body">
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex gap-2 flex-wrap align-items-center">
                                                    <span class="avatar avatar-xl me-1">
                                                        <img src="<?php echo base_url('assets/images/media/media-74.jpg'); ?>" class="img-fluid" alt="...">
                                                    </span>
                                                    <div class="flex-fill">
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex gap-2 flex-wrap align-items-center">
                                                    <span class="avatar avatar-xl me-1">
                                                        <img src="<?php echo base_url('assets/images/media/media-49.jpg'); ?>" class="img-fluid" alt="...">
                                                    </span>
                                                    <div class="flex-fill">
                                            ...
                                            <li class="list-group-item">
                                                    <div class="d-flex gap-2 flex-wrap align-items-center">
                                                    <span class="avatar avatar-xl me-1">
                                                        <img src="<?php echo base_url('assets/images/media/media-76.jpg'); ?>" class="img-fluid" alt="...">
                                                    </span>
                                                    <div class="flex-fill">
                                                        <a href="javascript:void(0);" class="fs-14 fw-semibold mb-0">Travel</a>
                                                        <p class="mb-1 popular-blog-content text-truncate">
