                                        ...
                                        <div class="card custom-card">
                                            <div class="card-body">
                                                ...
                                                <div class="btn-list text-center">
                                                    <a href="<?php echo base_url('profile'); ?>" class="btn btn-primary-light btn-sm">
                                                        Edit Profile
                                                    </a>
                                                    <a href="<?php echo base_url('profile'); ?>" class="btn btn-primary btn-sm">
                                                        View Profile
                                                    </a>
                                                </div>
                                            </div>
...
<?= $this->section('scripts'); ?>
        ...
        <!-- HRM Dashboard JS -->
        <script src="<?php echo base_url('assets/js/personal-dashboard.js'); ?>"></script>
