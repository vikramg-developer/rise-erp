                                                    ...
                                                    <div class="main-chat-msg">
                                                        ...
                                                        <div>
                                                            <p class="mb-0 d-sm-flex d-block">
                                                                <a aria-label="anchor" href="<?php echo base_url('gallery'); ?>" class="avatar avatar-xl m-1"><img src="<?php echo base_url('assets/images/media/media-64.jpg'); ?>" alt=""></a>
                                                                <a aria-label="anchor" href="<?php echo base_url('gallery'); ?>" class="avatar avatar-xl m-1"><img src="<?php echo base_url('assets/images/media/media-63.jpg'); ?>" alt=""></a>
                                                                <a aria-label="anchor" href="<?php echo base_url('gallery'); ?>" class="avatar avatar-xl m-1"><img src="<?php echo base_url('assets/images/media/media-62.jpg'); ?>" alt=""></a>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="mb-0">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                                            <a aria-label="anchor" href="<?php echo base_url('gallery'); ?>" class="chat-media">
                                                <img src="<?php echo base_url('assets/images/media/media-56.jpg'); ?>" alt="">
                                            </a>
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                                            <a aria-label="anchor" href="<?php echo base_url('gallery'); ?>" class="chat-media">
                                                <img src="<?php echo base_url('assets/images/media/media-52.jpg'); ?>" alt="">
                                            </a>
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                                            <a href="<?php echo base_url('gallery'); ?>" class="chat-media">
                                                <img src="<?php echo base_url('assets/images/media/media-53.jpg'); ?>" alt="">
                                            </a>
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                                            <a href="<?php echo base_url('gallery'); ?>" class="chat-media">
                                                <img src="<?php echo base_url('assets/images/media/media-62.jpg'); ?>" alt="">
                                            </a>
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                                            <a href="<?php echo base_url('gallery'); ?>" class="chat-media">
                                                <img src="<?php echo base_url('assets/images/media/media-63.jpg'); ?>" alt="">
                                            </a>
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                                            <a href="<?php echo base_url('gallery'); ?>" class="chat-media">
                                                <img src="<?php echo base_url('assets/images/media/media-64.jpg'); ?>" alt="">
                                            </a>
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                                            <a href="<?php echo base_url('gallery'); ?>" class="chat-media">
                                                <img src="<?php echo base_url('assets/images/media/media-13.jpg'); ?>" alt="">
                                            </a>
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                                            <a href="<?php echo base_url('gallery'); ?>" class="chat-media">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                                            <a href="<?php echo base_url('gallery'); ?>" class="chat-media">
                                                <img src="<?php echo base_url('assets/images/media/media-20.jpg'); ?>" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
