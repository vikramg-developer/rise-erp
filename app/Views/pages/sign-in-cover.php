                        ...
                        <div class="p-5">
                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-xl-12 mb-3">
                                    <label for="signin-password" class="form-label text-default d-block">Password<a href="<?php echo base_url('reset-password-cover'); ?>" class="float-end text-danger">Forget password ?</a></label>
                            ...
                            <div class="text-center">
                                <p class="fs-12 text-muted mt-4">Dont have an account? <a href="<?php echo base_url('sign-up-cover'); ?>" class="text-primary">Sign Up</a></p>
                            </div>
                        </div>
                    </div>
                </div>
