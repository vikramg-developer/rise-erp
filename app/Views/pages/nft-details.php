                                                        ...
                                                        <div class="swiper swiper-preview-details bg-light product-details-page">
                                                            <div class="swiper-wrapper">
                                                                <div class="swiper-slide" id="img-container">
                                                                    <img class="img-fluid" src="<?php echo base_url('assets/images/nft-images/32.png'); ?>" alt="img">
                                                                </div>
                                                                <div class="swiper-slide image-container">
                                                                    <img class="img-fluid" src="<?php echo base_url('assets/images/nft-images/31.png'); ?>" alt="img">
                                                                </div>
                                                                <div class="swiper-slide image-container">
                                                                    <img class="img-fluid" src="<?php echo base_url('assets/images/nft-images/30.png'); ?>" alt="img">
                                                                </div>
                                                                <div class="swiper-slide image-container">
                                                                    <img class="img-fluid" src="<?php echo base_url('assets/images/nft-images/33.png'); ?>" alt="img">
                                                                </div>
                                                            </div>
                                                                                ...
                                                                                <div class="d-flex align-items-top">
                                                                                    ...
                                                                                    <div class="text-center">
                                                                                        <p class="mb-0 fs-16 fw-semibold">
                                                                                            <span class="avatar avatar-xs avatar-rounded p-1"><img src="<?php echo base_url('assets/images/crypto-currencies/regular/Ethereum.svg'); ?>" alt=""></span>1.099
                                                                                        </p>
                                                                                        <p class="mb-0 text-muted">
                                                                                            <s><span class="avatar avatar-xs avatar-rounded p-1"><img src="<?php echo base_url('assets/images/crypto-currencies/regular/Ethereum.svg'); ?>" alt=""></span>1.759</s>
                                                                                        </p>
                                                                                    </div>
                                                                                </div>
                                                                            </a>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <a href="javascript:void(0);">
                                                                                <div class="d-flex align-items-top">
                                                                                    <div class="similar-products-image me-2">
                                                                                        <img src="<?php echo base_url('assets/images/nft-images/17.png'); ?>" alt="">
                                                                                    </div>
                                                                                    <div class="flex-fill">
                                                                                    ...
                                                                                    <div class="text-center">
                                                                                        <p class="mb-0 fs-16 fw-semibold">
                                                                                            <span class="avatar avatar-xs avatar-rounded p-1"><img src="<?php echo base_url('assets/images/crypto-currencies/regular/Ethereum.svg'); ?>" alt=""></span>7.99
                                                                                        </p>
                                                                                        <p class="mb-0 text-muted">
                                                                                            <s><span class="avatar avatar-xs avatar-rounded p-1"><img src="<?php echo base_url('assets/images/crypto-currencies/regular/Ethereum.svg'); ?>" alt=""></span>12.99</s>
                                                                                        </p>
                                                                                    </div>
                                                                                </div>
                                                                            </a>
                                                                        ...
                                                                        <td>
                                                                            <a href="javascript:void(0);">
                                                                                <div class="d-flex align-items-top">
                                                                                    ...
                                                                                    <div class="text-center">
                                                                                        <p class="mb-0 fs-16 fw-semibold">
                                                                                            <span class="avatar avatar-xs avatar-rounded p-1"><img src="<?php echo base_url('assets/images/crypto-currencies/regular/Ethereum.svg'); ?>" alt=""></span>1.499
                                                                                        </p>
                                                                                        <p class="mb-0 text-muted">
                                                                                            <s><span class="avatar avatar-xs avatar-rounded p-1"><img src="<?php echo base_url('assets/images/crypto-currencies/regular/Ethereum.svg'); ?>" alt=""></span>2.599</s>
                                                                                        </p>
                                                                                    </div>
                                                                                </div>
                                                                            </a>
                                                                        ...
                                                                        <td>
                                                                            <a href="javascript:void(0);">
                                                                                <div class="d-flex align-items-top">
                                                                                    ...
                                                                                    <div class="text-center">
                                                                                        <p class="mb-0 fs-16 fw-semibold">
                                                                                            <span class="avatar avatar-xs avatar-rounded p-1"><img src="<?php echo base_url('assets/images/crypto-currencies/regular/Ethereum.svg'); ?>" alt=""></span>2.299
                                                                                        </p>
                                                                                        <p class="mb-0 text-muted">
                                                                                            <s><span class="avatar avatar-xs avatar-rounded p-1"><img src="<?php echo base_url('assets/images/crypto-currencies/regular/Ethereum.svg'); ?>" alt=""></span>3.299</s>
                                                                                        </p>
                                                                                    </div>
                                                                                </div>
                                                                            </a>
                                                                        ...
                                                                        <td>
                                                                            <a href="javascript:void(0);">
                                                                                <div class="d-flex align-items-top">
                                                                                    ...
                                                                                    <div class="text-center">
                                                                                        <p class="mb-0 fs-16 fw-semibold">
                                                                                            <span class="avatar avatar-xs avatar-rounded p-1"><img src="<?php echo base_url('assets/images/crypto-currencies/regular/Ethereum.svg'); ?>" alt=""></span>8.99
                                                                                        </p>
                                                                                        <p class="mb-0 text-muted">
                                                                                            <s><span class="avatar avatar-xs avatar-rounded p-1"><img src="<?php echo base_url('assets/images/crypto-currencies/regular/Ethereum.svg'); ?>" alt=""></span>12.99</s>
                                                                                        </p>
                                                                        ...
                                                                        <td>
                                                                            <a href="javascript:void(0);">
                                                                                <div class="d-flex align-items-top">
                                                                                    ...
                                                                                    <div class="text-center">
                                                                                        <p class="mb-0 fs-16 fw-semibold">
                                                                                            <span class="avatar avatar-xs avatar-rounded p-1"><img src="<?php echo base_url('assets/images/crypto-currencies/regular/Ethereum.svg'); ?>" alt=""></span>1.799
                                                                                        </p>
                                                                                        <p class="mb-0 text-muted">
                                                                                            <s><span class="avatar avatar-xs avatar-rounded p-1"><img src="<?php echo base_url('assets/images/crypto-currencies/regular/Ethereum.svg'); ?>" alt=""></span>2.499</s>
                                                                                        </p>
                                                                                    </div>
                                                                                </div>
                                                                            </a>
                                                                            ...
                                                                            <a href="javascript:void(0);">
                                                                                <div class="d-flex align-items-top">
                                                                                    ...
                                                                                    <div class="text-center">
                                                                                        ...
                                                                                        <p class="mb-0 text-muted">
                                                                                            <s><span class="avatar avatar-xs avatar-rounded p-1"><img src="<?php echo base_url('assets/images/crypto-currencies/regular/Ethereum.svg'); ?>" alt=""></span>2.999</s>
                                                                                        </p>
                                                                                    </div>
                                                                                </div>
                                                                            </a>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="row mb-4">
                                                                <div class="col-xxl-3 col-xl-12">
                                                                    ...
                                                                    <p class="mb-1"><span class="h3"><span class="avatar avatar-sm avatar-rounded p-1 bg-light me-2"><img src="<?php echo base_url('assets/images/crypto-currencies/regular/Ethereum.svg'); ?>" alt=""></span>1.299<sup class="fs-14">.00</sup></span><span class="ms-3 badge bg-danger-transparent">50% Off</span></p>
