                                ...
                                <div class="row">
                                    <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-8">
                                        <div class="py-lg-5">
                                            ...
                                            <a href="index<?php echo base_url(''); ?>" class="m-1 btn btn-primary">
                                                View Demos
                        ...
                        <div class="container text-center">
                            ...
                            <div class="col-xxl-5 col-xl-5 col-lg-5 customize-image text-center">
                                <div class="text-lg-end">
                                    <img src="<?php echo base_url('assets/images/media/landing/3.png'); ?>" alt="" class="img-fluid">
                                </div>
                            </div>
                                    ...
                                    <div class="">
                                        <div class="feature-logos mt-sm-5 flex-wrap" >
                                            <div class="ms-sm-5 ms-2 text-center">
                                                <img src="<?php echo base_url('assets/images/media/landing/web/1'); ?>.png" alt="image" class="featur-icon">
                                                <h5 class="mt-3 text-fixed-white ">Bootstrap5</h5>
                                            </div>
                                            <div class="ms-sm-5 ms-2 text-center">
                                                <img src="<?php echo base_url('assets/images/media/landing/web/2'); ?>.png" alt="image" class="featur-icon">
                                                <h5 class="mt-3 text-fixed-white ">HTML5</h5>
                                            </div>
                                            <div class="ms-sm-5 ms-2 text-center">
                                                <img src="<?php echo base_url('assets/images/media/landing/web/4'); ?>.png" alt="image" class="featur-icon">
                                                <h5 class="mt-3 text-fixed-white ">Sass</h5>
                                            </div>       
                                            <div class="ms-sm-5 ms-2 text-center">
                                                <img src="<?php echo base_url('assets/images/media/landing/web/5'); ?>.png" alt="image" class="featur-icon">
                                                <h5 class="mt-3 text-fixed-white ">Esbuild</h5>
                                            </div>
                                            <div class="ms-sm-5 ms-2 text-center">
                                                <img src="<?php echo base_url('assets/images/media/landing/web/6'); ?>.png" alt="image" class="featur-icon">
                                ...
                                <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                    <div class="card custom-card text-center team-card ">
                                        <div class="card-body p-5">
                                            ...
                                            <div class="mt-2">
                                                <a href="<?php echo base_url('profile'); ?>" class="btn btn-light" target="_blank">View profile</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-4 col-sm-6 col-12 mb-md-0 mb-3">
                                    <div class="px-4">
                                        <p class="fw-semibold mb-3"><a href="index<?php echo base_url(''); ?>"><img src="<?php echo base_url('assets/images/brand-logos/desktop-dark.png'); ?>" alt=""></a></p>
