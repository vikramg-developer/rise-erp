                                                        ...
                                                        <div class="swiper swiper-preview-details bg-light product-details-page">
                                                            <div class="swiper-wrapper">
                                                                <div class="swiper-slide" id="img-container">
                                                                    <img class="img-fluid" src="<?php echo base_url('assets/images/ecommerce/png/15.png'); ?>" alt="img">
                                                                </div>
                                                                <div class="swiper-slide image-container">
                                                                    <img class="img-fluid" src="<?php echo base_url('assets/images/ecommerce/png/13.png'); ?>" alt="img">
                                                                </div>
                                                                <div class="swiper-slide image-container">
                                                                    <img class="img-fluid" src="<?php echo base_url('assets/images/ecommerce/png/14.png'); ?>" alt="img">
                                                                </div>
                                                                <div class="swiper-slide image-container">
                                                                    <img class="img-fluid" src="<?php echo base_url('assets/images/ecommerce/png/17.png'); ?>" alt="img">
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <a href="javascript:void(0);">
                                                                                <div class="d-flex align-items-top">
                                                                                    <div class="similar-products-image me-2">
                                                                                        <img src="<?php echo base_url('assets/images/ecommerce/png/17.png'); ?>" alt="">
                                                                                    </div>
                                                                                    <div class="flex-fill">
                                                ...
                                                <div class="row gx-5">
                                                    ...
                                                    <div class="col-xl-4 mt-xxl-0 mt-3">
                                                        ...
                                                        <div class="offer-promotion mb-4">
                                                            ...
                                                            <div class="d-grid">
                                                                <a href="<?php echo base_url('cart'); ?>" class="btn btn-primary mb-2">Add To Cart</a>
                                                                <a href="<?php echo base_url('checkout'); ?>" class="btn btn-success mb-2">Buy Now</a>
                                                                <a href="<?php echo base_url('wishlist'); ?>" class="btn btn-light">Add To Wishlist</a>
                                                            </div>
                                                        </div>
                                                        <div class="text-center">
                                                            <a href="javascript:void(0);">
                                                                <img src="<?php echo base_url('assets/images/ecommerce/png/25.png'); ?>" alt="" class="img-fluid rounded bg-light">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
