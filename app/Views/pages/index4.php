                                        ...
                                        <div class="row gap-3 gap-sm-0">
                                            ...
                                            <div class="col-sm-4 col-auto my-auto">
                                                <div class="featured-nft">
                                                    <img src="<?php echo base_url('assets/images/nft-images/1.png'); ?>" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xxl-8 col-xl-12 col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                                        <div class="card custom-card">
                                            <img src="<?php echo base_url('assets/images/nft-images/2.png'); ?>" class="card-img-top" alt="...">
                                    ...
                                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                                        <div class="card custom-card">
                                            <img src="<?php echo base_url('assets/images/nft-images/3.png'); ?>" class="card-img-top" alt="...">
                                            <div class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                <div class="flex-fill">
                                                    <button class="btn btn-sm btn-icon btn-success rounded-pill btn-wave">
                                                        <i class="ri-heart-fill"></i>
                                    ...
                                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                                        <div class="card custom-card">
                                            <img src="<?php echo base_url('assets/images/nft-images/5.png'); ?>" class="card-img-top" alt="...">
                                            <div class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                <div class="flex-fill">
                                                    <button class="btn btn-sm btn-icon btn-success rounded-pill btn-wave">
                                                        <i class="ri-heart-fill"></i>
                                    ...
                                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                                        <div class="card custom-card">
                                            <img src="<?php echo base_url('assets/images/nft-images/4.png'); ?>" class="card-img-top" alt="...">
                                            <div class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                <div class="flex-fill">
                                                    <button class="btn btn-sm btn-icon btn-success rounded-pill btn-wave">
                                                        <i class="ri-heart-fill"></i>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card custom-card">
                                                <div class="card-body">
                                                    <div class="row g-2">
                                                        <div class="col-6">
                                                            <img src="<?php echo base_url('assets/images/nft-images/6.png'); ?>" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                        <div class="col-6">
                                                            <img src="<?php echo base_url('assets/images/nft-images/7.png'); ?>" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                        <div class="col-6">
                                                            <img src="<?php echo base_url('assets/images/nft-images/8.png'); ?>" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                        <div class="col-6">
                                                            <img src="<?php echo base_url('assets/images/nft-images/9.png'); ?>" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card custom-card">
                                                <div class="card-body">
                                                    <div class="row g-2">
                                                        <div class="col-6">
                                                            <img src="<?php echo base_url('assets/images/nft-images/11.png'); ?>" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                        <div class="col-6">
                                                            <img src="<?php echo base_url('assets/images/nft-images/12.png'); ?>" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                        <div class="col-6">
                                                            <img src="<?php echo base_url('assets/images/nft-images/13.png'); ?>" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                        <div class="col-6">
                                                            <img src="<?php echo base_url('assets/images/nft-images/14.png'); ?>" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="card-footer">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card custom-card">
                                                <div class="card-body">
                                                    <div class="row g-2">
                                                        <div class="col-6">
                                                            <img src="<?php echo base_url('assets/images/nft-images/10.png'); ?>" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                        <div class="col-6">
                                                            <img src="<?php echo base_url('assets/images/nft-images/15.png'); ?>" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                        <div class="col-6">
                                                            <img src="<?php echo base_url('assets/images/nft-images/17.png'); ?>" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                        <div class="col-6">
                                                            <img src="<?php echo base_url('assets/images/nft-images/16.png'); ?>" alt="" class="nft-featuredcollect-image">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="card-footer">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="me-2 lh-1">
                                                                    <span class="avatar avatar-md avatar-rounded">
                                                                        <img src="<?php echo base_url('assets/images/nft-images/2.png'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                                <div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="me-2 lh-1">
                                                                    <span class="avatar avatar-md avatar-rounded">
                                                                        <img src="<?php echo base_url('assets/images/nft-images/15.png'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                                <div>
                                                                    <p class="mb-0 fw-semibold"><a href="javascript:void(0);" title="nft_name">
                                                ...
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="mb-0 fw-semibold d-flex align-items-center"><span class="avatar avatar-sm p-1"><img src="<?php echo base_url('assets/images/crypto-currencies/regular/Ethereum.svg'); ?>" alt=""></span>1.75ETH</p>
                                                        </div>
                                                    </div>
                                                </a>
                                            </li>
                                            <li class="list-group-item">
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                        ...
                                                        <div>
                                                            <span class="fs-10 text-muted ps-4">PRICE</span>
                                                            <p class="mb-0 fw-semibold d-flex align-items-center"><span class="avatar avatar-sm p-1"><img src="<?php echo base_url('assets/images/crypto-currencies/regular/Ethereum.svg'); ?>" alt=""></span>1.15ETH</p>
                                                        </div>
                                                    </div>
                                                </a>    
                                            </li>
                                            <li class="list-group-item">
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                        ...
                                                        <div>
                                                            <span class="fs-10 text-muted ps-4">PRICE</span>
                                                            <p class="mb-0 fw-semibold d-flex align-items-center"><span class="avatar avatar-sm p-1"><img src="<?php echo base_url('assets/images/crypto-currencies/regular/Ethereum.svg'); ?>" alt=""></span>1.58ETH</p>
                                                        </div>
                                                    </div>
                                                </a>    
                                            </li>
                                                ...
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2 lh-1">
                                                                <span class="avatar avatar-md">
                                                                    <img src="<?php echo base_url('assets/images/nft-images/4.png'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                        ...
                                                        <div>
                                                            <span class="fs-10 text-muted ps-4">PRICE</span>
                                                            <p class="mb-0 fw-semibold d-flex align-items-center"><span class="avatar avatar-sm p-1"><img src="<?php echo base_url('assets/images/crypto-currencies/regular/Ethereum.svg'); ?>" alt=""></span>1.19ETH</p>
                                                        </div>
                                                    </div>
                                                </a>    
                                            </li>
                                            <li class="list-group-item">
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                        ...
                                                        <div>
                                                            <span class="fs-10 text-muted ps-4">PRICE</span>
                                                            <p class="mb-0 fw-semibold d-flex align-items-center"><span class="avatar avatar-sm p-1"><img src="<?php echo base_url('assets/images/crypto-currencies/regular/Ethereum.svg'); ?>" alt=""></span>2.45ETH</p>
                                                        </div>
                                                    </div>
                                                </a>    
                                            </li>
                                                ...
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2 lh-1">
                                                                <span class="avatar avatar-md">
                                                                    <img src="<?php echo base_url('assets/images/nft-images/16.png'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                        ...
                                                        <div>
                                                            <span class="fs-10 text-muted ps-4">PRICE</span>
                                                            <p class="mb-0 fw-semibold d-flex align-items-center"><span class="avatar avatar-sm p-1"><img src="<?php echo base_url('assets/images/crypto-currencies/regular/Ethereum.svg'); ?>" alt=""></span>1.95ETH</p>
                                                        </div>
                                                    </div>
                                                </a>    
                                            </li>
                                                ...
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2 lh-1">
                                                                <span class="avatar avatar-md">
                                                                    <img src="<?php echo base_url('assets/images/nft-images/6.png'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                        ...
                                                        <div>
                                                            <span class="fs-10 text-muted ps-4">PRICE</span>
                                                            <p class="mb-0 fw-semibold d-flex align-items-center"><span class="avatar avatar-sm p-1"><img src="<?php echo base_url('assets/images/crypto-currencies/regular/Ethereum.svg'); ?>" alt=""></span>1.12ETH</p>
                                                        </div>
                                                    </div>
                                                </a>    
                                            </li>
