                                ...
                                <div class="card custom-card">
                                    <div class="card-body contact-action">
                                        ...
                                        <div class="d-flex align-items-top">
                                            <div class="d-flex flex-fill flex-wrap gap-3">
                                                <div class="avatar avatar-xl avatar-rounded">
                                                    <img src="<?php echo base_url('assets/images/media/media-36.jpg'); ?>" alt="">
                                                </div>
                                                <div>
                                                    <h6 class="mb-1 fw-semibold">
                                                        Anelica Julie
                                ...
                                <div class="card custom-card">
                                    <div class="card-body contact-action">
                                        ...
                                        <div class="d-flex align-items-top">
                                            <div class="d-flex flex-fill flex-wrap gap-3">
                                                <div class="avatar avatar-xl avatar-rounded">
                                                    <img src="<?php echo base_url('assets/images/media/media-8.jpg'); ?>" alt="">
                                                </div>
                                                <div>
                                                    <h6 class="mb-1 fw-semibold">
                                                        Json Taylor
                                ...
                                <div class="card custom-card">
                                    <div class="card-body contact-action">
                                        ...
                                        <div class="d-flex align-items-top">
                                            <div class="d-flex flex-fill flex-wrap gap-3">
                                                <div class="avatar avatar-xl avatar-rounded">
                                                    <img src="<?php echo base_url('assets/images/media/media-34.jpg'); ?>" alt="">
                                                </div>
                                                <div>
                                                    <h6 class="mb-1 fw-semibold">
                                                        Gahaskar Shaik
