                                    ...
                                    <div class="row">
                                        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                            <div class="card custom-card product-card">
                                                <div class="card-body">
                                                    <a href="<?php echo base_url('product-details'); ?>" class="product-image">
                                                        <img src="<?php echo base_url('assets/images/ecommerce/png/1.png'); ?>" class="card-img mb-3" alt="...">
                                                    </a>
                                                    <div class="product-icons">
                                                        <a href="<?php echo base_url('wishlist'); ?>" class="wishlist"><i class="ri-heart-line"></i></a>
                                                        <a href="<?php echo base_url('cart'); ?>" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                                        <a href="<?php echo base_url('product-details'); ?>" class="view"><i class="ri-eye-line"></i></a>
                                                    </div>
