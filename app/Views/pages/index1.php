                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                        <div class="card custom-card overflow-hidden">
                                            <div class="ecommerce-sale-image">
                                                <img src="<?php echo base_url('assets/images/ecommerce/png/35.png'); ?>" class="card-img-top" alt="...">
                                                            ...
                                                            <table class="table card-table table-vcenter text-nowrap mb-0">
                                                                <tbody class="active-tab">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <span class="avatar avatar-md">
                                                                                <img src="<?php echo base_url('assets/images/ecommerce/png/2.png'); ?>" alt="">
                                                                            </span>
                                                                        </td>
                                                                        <td>
                                                                            <a aria-label="anchor" href="javascript:void(0);">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <span class="avatar avatar-md">
                                                                                <img src="<?php echo base_url('assets/images/ecommerce/png/3.png'); ?>" alt="">
                                                                            </span>
                                                                        </td>
                                                                        <td>
                                                                            <a aria-label="anchor" href="javascript:void(0);">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <span class="avatar avatar-md">
                                                                                <img src="<?php echo base_url('assets/images/ecommerce/png/4.png'); ?>" alt="">
                                                                            </span>
                                                                        </td>
                                                                        <td>
                                                                            <a aria-label="anchor" href="javascript:void(0);">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <span class="avatar avatar-md">
                                                                                <img src="<?php echo base_url('assets/images/ecommerce/png/5.png'); ?>" alt="">
                                                                            </span>
                                                                        </td>
                                                                        <td>
                                                                            <a aria-label="anchor" href="javascript:void(0);">
                                                            ...
                                                            <table class="table card-table table-vcenter text-nowrap mb-0">
                                                                <tbody class="active-tab">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <span class="avatar avatar-md">
                                                                                <img src="<?php echo base_url('assets/images/ecommerce/png/10.png'); ?>" alt="">
                                                                            </span>
                                                                        </td>
                                                                        <td>
                                                                            <a aria-label="anchor" href="javascript:void(0);">
                                                        ...
                                                        <tbody class="top-selling">
                                                            <tr>
                                                                <td class="text-center lh-1">
                                                                    <span class="avatar avatar-md">
                                                                        <img src="<?php echo base_url('assets/images/ecommerce/png/36.png'); ?>" class="p-2 rounded-pill bg-light" alt="">
                                                                    </span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td class="text-center lh-1">
                                                                    <span class="avatar avatar-md">
                                                                        <img src="<?php echo base_url('assets/images/ecommerce/png/38.png'); ?>" class="p-2 rounded-pill bg-light" alt="">
                                                                    </span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td class="text-center lh-1">
                                                                    <span class="avatar avatar-md">
                                                                        <img src="<?php echo base_url('assets/images/ecommerce/png/39.png'); ?>" class="p-2 rounded-pill bg-light" alt="">
                                                                    </span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td class="text-center lh-1">
                                                                    <span class="avatar avatar-md">
                                                                        <img src="<?php echo base_url('assets/images/ecommerce/png/40.png'); ?>" class="p-2 rounded-pill bg-light" alt="">
                                                                    </span>
                                                                </td>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="me-2 lh-1">
                                                                    <span class="avatar avatar-sm">
                                                                        <img src="<?php echo base_url('assets/images/ecommerce/png/36.png'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="me-2 lh-1">
                                                                    <span class="avatar avatar-sm">
                                                                        <img src="<?php echo base_url('assets/images/ecommerce/png/37.png'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="me-2 lh-1">
                                                                    <span class="avatar avatar-sm">
                                                                        <img src="<?php echo base_url('assets/images/ecommerce/png/38.png'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="me-2 lh-1">
                                                                    <span class="avatar avatar-sm">
                                                                        <img src="<?php echo base_url('assets/images/ecommerce/png/39.png'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="me-2 lh-1">
                                                                    <span class="avatar avatar-sm">
                                                                        <img src="<?php echo base_url('assets/images/ecommerce/png/40.png'); ?>" alt="">
                                                                    </span>
                                                                </div>
