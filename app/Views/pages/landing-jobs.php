...
<?= $this->extend('layouts/landing-main1'); ?>
                        ...
                        <div class="row">
                                ...
                                <div class="card custom-card border">
                                    <div class="row g-0">
                                        <div class="col-md-3 col-4">
                                            <img src="<?php echo base_url('assets/images/media/jobs-landing/1.jpg'); ?>" class="img-fluid rounded-start h-100 browse-jobs-image" alt="...">
                                        </div>
                                        <div class="col-md-9 col-8 my-auto">
                                            <div class="card-body">
                                                ...
                                                <a class="text-primary fw-semibold" href="javascript:void(0);">Explore Jobs<i class="ri-arrow-right-s-line align-middle"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="card custom-card border">
                                    <div class="row g-0">
                                        <div class="col-md-3 col-4">
                                            <img src="<?php echo base_url('assets/images/media/jobs-landing/2.jpg'); ?>" class="img-fluid rounded-start h-100 browse-jobs-image" alt="...">
                                        </div>
                                        <div class="col-md-9 col-8 my-auto">
                                            <div class="card-body">
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="card custom-card border">
                                    <div class="row g-0">
                                        <div class="col-md-3 col-4">
                                            <img src="<?php echo base_url('assets/images/media/jobs-landing/3.jpg'); ?>" class="img-fluid rounded-start h-100 browse-jobs-image" alt="...">
                                        </div>
                                        <div class="col-md-9 col-8 my-auto">
                                            <div class="card-body">
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="card custom-card border">
                                    <div class="row g-0">
                                        <div class="col-md-3 col-4">
                                            <img src="<?php echo base_url('assets/images/media/jobs-landing/4.jpg'); ?>" class="img-fluid rounded-start h-100 browse-jobs-image" alt="...">
                                        </div>
                                        <div class="col-md-9 col-8 my-auto">
                                            <div class="card-body">
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="card custom-card border">
                                    <div class="row g-0">
                                        <div class="col-md-3 col-4">
                                            <img src="<?php echo base_url('assets/images/media/jobs-landing/5.jpg'); ?>" class="img-fluid rounded-start h-100 browse-jobs-image" alt="...">
                                        </div>
                                        <div class="col-md-9 col-8 my-auto">
                                            <div class="card-body">
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="card custom-card border">
                                    <div class="row g-0">
                                        <div class="col-md-3 col-4">
                                            <img src="<?php echo base_url('assets/images/media/jobs-landing/6.jpg'); ?>" class="img-fluid rounded-start h-100 browse-jobs-image" alt="...">
                                        </div>
                                        <div class="col-md-9 col-8 my-auto">
                                            <div class="card-body">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="card custom-card border">
                                    <div class="card-body rounded">
                                        ...
                                        <a class="mx-1 text-primary fw-semibold" href="javascript:void(0);">Register Now<i class="ri-arrow-right-s-line align-middle"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="card custom-card border">
                                    <div class="card-body rounded">
                                        ...
                                        <a class="mx-1 text-primary fw-semibold" href="javascript:void(0);">Complete Profile<i class="ri-arrow-right-s-line align-middle"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="card custom-card border">
                                    <div class="card-body rounded">
                                        ...
                                        <a class="mx-1 text-primary fw-semibold" href="javascript:void(0);">Apply Now<i class="ri-arrow-right-s-line align-middle"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="row align-items-center justify-content-center">
                            <div class="col-md-5 col-xl-4 text-center mt-4 d-lg-block d-none">
                                <img src="<?php echo base_url('assets/images/media/jobs-landing/8.png'); ?>" width="350" alt="">
                            </div>
                    ...
                    <div class="container">
                        <div class="row align-items-center justify-content-center">
                            <div class="col-lg-4 d-lg-block d-none text-center mt-4">
                                <img src="<?php echo base_url('assets/images/media/jobs-landing/7.png'); ?>" width="260" alt="">
                            </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row row-cols-1 row-cols-md-3 g-4">
                            <div class="col">
                                <div class="card custom-card border shadow-none">
                                    <a href="javascript:void(0);">
                                        <img src="<?php echo base_url('assets/images/media/jobs-landing/blog/1'); ?>.jpg" class="card-img-top" alt="...">
                                    </a>
                                    <div class="card-body">
                                        ...
                                        <a class="text-primary fw-semibold" href="javascript:void(0);">Read this post<i class="ri-arrow-right-s-line align-middle transform-arrow"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card custom-card border shadow-none">
                                    <a href="javascript:void(0);">
                                        <img src="<?php echo base_url('assets/images/media/jobs-landing/blog/2'); ?>.jpg" class="card-img-top" alt="...">
                                    </a>
                                    <div class="card-body">
                            ...
                            <div class="col">
                                <div class="card custom-card border shadow-none">
                                    <a href="javascript:void(0);">
                                        <img src="<?php echo base_url('assets/images/media/jobs-landing/blog/3'); ?>.jpg" class="card-img-top" alt="...">
                                    </a>
                                    <div class="card-body">
