                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active" data-bs-interval="2000">
                                                    <a href="javascript:void(0);">
                                                        <img src="<?php echo base_url('assets/images/media/media-70.jpg'); ?>" class="d-block w-100" alt="...">
                                                ...
                                                <div class="carousel-item" data-bs-interval="2000">
                                                    <a href="javascript:void(0);">
                                                        <img src="<?php echo base_url('assets/images/media/media-71.jpg'); ?>" class="d-block w-100" alt="...">
                                                        <div class="carousel-caption blog-caption text-start">
                                                ...
                                                <div class="carousel-item" data-bs-interval="2000">
                                                    <a href="javascript:void(0);">
                                                        <img src="<?php echo base_url('assets/images/media/media-72.jpg'); ?>" class="d-block w-100" alt="...">
                                                        <div class="carousel-caption blog-caption text-start">
                                ...
                                <div class="row">
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                        <div class="card custom-card">
                                            <a href="javascript:void(0);">
                                                <img src="<?php echo base_url('assets/images/media/media-36.jpg'); ?>" class="card-img-top" alt="...">
                                            </a>
                                            <div class="card-body">
                                                <a href="<?php echo base_url('blog-details'); ?>" class="fw-semibold fs-14 text-dark mb-1">Touring excites in winter !</a>
                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                        <div class="card custom-card">
                                            <a href="javascript:void(0);">
                                                <img src="<?php echo base_url('assets/images/media/media-35.jpg'); ?>" class="card-img-top" alt="...">
                                            </a>
                                            <div class="card-body">
                                                <a href="<?php echo base_url('blog-details'); ?>" class="fw-semibold fs-14 text-dark mb-1"> Boat manufacutrers are in debt !</a>
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="row">
                                    <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6">
                                        <a href="javascript:void(0);">
                                            <div class="card custom-card bg-dark overlay-card text-fixed-white">
                                                <img src="<?php echo base_url('assets/images/media/media-73.jpg'); ?>" class="card-img" alt="...">
                                    ...
                                    <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6">
                                        <a href="javascript:void(0);">
                                            <div class="card custom-card bg-dark overlay-card text-fixed-white">
                                                <img src="<?php echo base_url('assets/images/media/media-74.jpg'); ?>" class="card-img" alt="...">
                                                <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                                    <div class="card-footer border-top-0">
                                    ...
                                    <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6">
                                        <a href="javascript:void(0);">
                                            <div class="card custom-card bg-dark overlay-card text-fixed-white">
                                                <img src="<?php echo base_url('assets/images/media/media-75.jpg'); ?>" class="card-img" alt="...">
                                                <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                                    <div class="card-footer border-top-0">
                                    ...
                                    <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6">
                                        <a href="javascript:void(0);">
                                            <div class="card custom-card bg-dark overlay-card text-fixed-white">
                                                <img src="<?php echo base_url('assets/images/media/media-76.jpg'); ?>" class="card-img" alt="...">
                                                <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                                    <div class="card-footer border-top-0">
                                    ...
                                    <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6">
                                        <a href="javascript:void(0);">
                                            <div class="card custom-card bg-dark overlay-card text-fixed-white">
                                                <img src="<?php echo base_url('assets/images/media/media-77.jpg'); ?>" class="card-img" alt="...">
                                                <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                                    <div class="card-footer border-top-0">
                                    ...
                                    <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6">
                                        <a href="javascript:void(0);">
                                            <div class="card custom-card bg-dark overlay-card text-fixed-white">
                                                <img src="<?php echo base_url('assets/images/media/media-78.jpg'); ?>" class="card-img" alt="...">
                                                <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                                    <div class="card-footer border-top-0">
                                    ...
                                    <div class="col-xl-6 col-xxl-8 col-lg-12 col-md-12">
                                        <div class="row">
                                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                                <div class="card custom-card">
                                                    <a href="javascript:void(0);">
                                                        <img src="<?php echo base_url('assets/images/media/media-26.jpg'); ?>" class="card-img-top" alt="...">
                                                    </a>
                                                    <div class="card-body">
                                                        <a href="<?php echo base_url('blog-details'); ?>" class="fw-semibold fs-14 text-dark mb-1">Features of new car !</a>
                                                        <p class="card-text text-muted mb-3">The holographic principle, theorized to be a property of quantum gravity, postulates that the description.</p>
                                                        <a href="javascript:void(0);" class="btn btn-primary-light">Read More</a>
                                                    </div>
                                                    <div class="card-footer">
                                            ...
                                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                                <div class="card custom-card">
                                                    <a href="javascript:void(0);">
                                                        <img src="<?php echo base_url('assets/images/media/media-31.jpg'); ?>" class="card-img-top" alt="...">
                                                    </a>
                                                    <div class="card-body">
                                                        <a href="<?php echo base_url('blog-details'); ?>" class="fw-semibold fs-14 text-dark mb-1">Beautiful beach on a sunny day !</a>
                                                        <p class="card-text text-muted mb-3">The holographic principle, theorized to be a property of quantum gravity, postulates that the description.</p>
                                                        <a href="javascript:void(0);" class="btn btn-primary-light">Read More</a>
                                                    </div>
                                                    <div class="card-footer">
                                            ...
                                            <div class="card-body">
                                                <ul class="list-group">
                                                    <li class="list-group-item">
                                                        <div class="d-flex flex-wrap align-items-center">
                                                            <span class="avatar avatar-xl me-3">
                                                                <img src="<?php echo base_url('assets/images/media/media-39.jpg'); ?>" class="img-fluid" alt="...">
                                                            </span>
                                                            <div class="flex-fill">
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="d-flex flex-wrap align-items-center">
                                                            <span class="avatar avatar-xl me-3">
                                                                <img src="<?php echo base_url('assets/images/media/media-56.jpg'); ?>" class="img-fluid" alt="...">
                                                            </span>
                                                            <div class="flex-fill">
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="d-flex flex-wrap align-items-center">
                                                            <span class="avatar avatar-xl me-3">
                                                                <img src="<?php echo base_url('assets/images/media/media-54.jpg'); ?>" class="img-fluid" alt="...">
                                                            </span>
                                                            <div class="flex-fill">
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="d-flex flex-wrap align-items-center">
                                                            <span class="avatar avatar-xl me-3">
                                                                <img src="<?php echo base_url('assets/images/media/media-52.jpg'); ?>" class="img-fluid" alt="...">
                                                            </span>
                                                            <div class="flex-fill">
                                ...
                                <div class="row">
                                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="card custom-card">
                                            ...
                                            <div class="card-body">
                                                <a href="<?php echo base_url('blog-details'); ?>" class="fw-semibold fs-14 text-dark mb-1">Strawberry juice recipe.</a>
                                    ...
                                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="card custom-card">
                                            <a href="javascript:void(0);">
                                                <img src="<?php echo base_url('assets/images/media/media-61.jpg'); ?>" class="card-img-top" alt="...">
                                            </a>
                                            <div class="card-body">
                                                <a href="<?php echo base_url('blog-details'); ?>" class="fw-semibold fs-14 text-dark mb-1">Night Sky is pleasent to watch.</a>
                                    ...
                                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="card custom-card">
                                            ...
                                            <div class="card-body">
                                                <a href="<?php echo base_url('blog-details'); ?>" class="fw-semibold fs-14 text-dark mb-1">Is fashion industry growing ?</a>
                                                <p class="card-text text-muted mb-3">The holographic principle, theorized to be a property of quantum gravity, postulates that the description.</p>
                                                <a href="javascript:void(0);" class="btn btn-primary-light">Read More</a>
                                            </div>
                                            <div class="card-footer">
                                    ...
                                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="card custom-card">
                                            <a href="javascript:void(0);">
                                                <img src="<?php echo base_url('assets/images/media/media-59.jpg'); ?>" class="card-img-top" alt="...">
                                            </a>
                                            <div class="card-body">
                                                <a href="<?php echo base_url('blog-details'); ?>" class="fw-semibold fs-14 text-dark mb-1">Raising sun is a blessing to watch ..</a>
