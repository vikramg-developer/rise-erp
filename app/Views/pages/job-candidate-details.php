                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center flex-wrap justify-content-between gap-2">
                                                <div class="d-flex flex-wrap gap-2">
                                                    <div>
                                                        <span class="avatar avatar-xxl avatar-rounded">
                                                            <img src="<?php echo base_url('assets/images/faces/1.jpg'); ?>" class="rounded-circle img-fluid" alt="">
                                                        </span>
                                                    </div>    
                                                    <div class="ms-3">
                                                        ...
                                                        <div class="d-flex flex-wrap gap-2 align-items-center fs-11 text-muted">
                                                            ...
                                                            <a href="#" class="ms-1 min-w-fit-content text-muted">
                                                                <span>(142)</span>
                                                                <span>Ratings</span>
                                                            </a>
                                                        </div>
                                                ...
                                                <div class="btn-list">
                                                    <a href="#" class="btn btn-primary"><i class="bi bi-download me-1"></i> Download CV</a>
                                                    <a href="#" class="btn btn-icon btn-primary-light btn-wave">
                                                            ...
                                                            <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                                ...
                                                                <div class="flex-fill">
                                                                    ...
                                                                    <div class="d-flex align-items-center fs-12 text-muted">
                                                                        ...
                                                                        <a href="#" class="mb-0 ms-1 min-w-fit-content text-muted">
                                                                            <span>(35)</span>
                                                                            <span>Ratings</span>
                                                                        </a>
                                                                    </div>
