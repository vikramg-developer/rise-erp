                                ...
                                <div class="card custom-card">
                                    ...
                                    <div class="card-body">
                                        <nav class="navbar bg-light mb-3">
                                            <div class="container-fluid">
                                                <a class="navbar-brand" href="javascript:void(0);"><img src="<?php echo base_url('assets/images/brand-logos/toggle-logo.png'); ?>" alt=""></a>
                                            </div>
                                        </nav>
                            ...
                            <div class="col-xl-12">
                                <div class="card custom-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <nav class="navbar bg-light mb-3">
                                            <div class="container-fluid">
                                                <a class="navbar-brand"><img src="<?php echo base_url('assets/images/brand-logos/toggle-logo.png'); ?>" alt=""></a>
                                                <form class="d-flex" role="search">
                                                    <input class="form-control me-2" type="search" placeholder="Search"
                                                        aria-label="Search">
                                                    <button class="btn btn-primary" type="submit">Search</button>
                                ...
                                <div class="card custom-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <nav class="navbar navbar-expand-lg navbar-secondary mb-3">
                                            <div class="container-fluid">
                                                <a class="navbar-brand" href="javascript:void(0);"><img src="<?php echo base_url('assets/images/brand-logos/toggle-dark.png'); ?>" alt=""></a>
                                                <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
