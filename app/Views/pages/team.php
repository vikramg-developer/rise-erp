                                ...
                                <div class="team-members" id="team-members">
                                    <div class="row">
                                        ...
                                        <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12"> 
                                            <div class="card custom-card team-member-card">
                                                <div class="teammember-cover-image">
                                                    <img src="<?php echo base_url('assets/images/media/team-covers/1.jpg'); ?>" class="card-img-top" alt="...">
                                        ...
                                        <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12"> 
                                            <div class="card custom-card team-member-card">
                                                <div class="teammember-cover-image">
                                                    <img src="<?php echo base_url('assets/images/media/team-covers/2.jpg'); ?>" class="card-img-top" alt="...">
                                                    <span class="avatar avatar-xl avatar-rounded">
                                        ...
                                        <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12"> 
                                            <div class="card custom-card team-member-card">
                                                <div class="teammember-cover-image">
                                                    <img src="<?php echo base_url('assets/images/media/team-covers/3.jpg'); ?>" class="card-img-top" alt="...">
                                                    <span class="avatar avatar-xl avatar-rounded">
                                        ...
                                        <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12"> 
                                            <div class="card custom-card team-member-card">
                                                <div class="teammember-cover-image">
                                                    <img src="<?php echo base_url('assets/images/media/team-covers/4.jpg'); ?>" class="card-img-top" alt="...">
                                                    <span class="avatar avatar-xl avatar-rounded">
                                        ...
                                        <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12"> 
                                            <div class="card custom-card team-member-card">
                                                <div class="teammember-cover-image">
                                                    <img src="<?php echo base_url('assets/images/media/team-covers/5.jpg'); ?>" class="card-img-top" alt="...">
                                                    <span class="avatar avatar-xl avatar-rounded">
                                        ...
                                        <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12"> 
                                            <div class="card custom-card team-member-card">
                                                <div class="teammember-cover-image">
                                                    <img src="<?php echo base_url('assets/images/media/team-covers/6.jpg'); ?>" class="card-img-top" alt="...">
                                                    <span class="avatar avatar-xl avatar-rounded">
                                        ...
                                        <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12"> 
                                            <div class="card custom-card team-member-card">
                                                <div class="teammember-cover-image">
                                                    <img src="<?php echo base_url('assets/images/media/team-covers/7.jpg'); ?>" class="card-img-top" alt="...">
                                                    <span class="avatar avatar-xl avatar-rounded">
                                        ...
                                        <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12"> 
                                            <div class="card custom-card team-member-card">
                                                <div class="teammember-cover-image">
                                                    <img src="<?php echo base_url('assets/images/media/team-covers/8.jpg'); ?>" class="card-img-top" alt="...">
                                                    <span class="avatar avatar-xl avatar-rounded">
                                        ...
                                        <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12"> 
                                            <div class="card custom-card team-member-card">
                                                <div class="teammember-cover-image">
                                                    <img src="<?php echo base_url('assets/images/media/team-covers/9.jpg'); ?>" class="card-img-top" alt="...">
                                                    <span class="avatar avatar-xl avatar-rounded">
