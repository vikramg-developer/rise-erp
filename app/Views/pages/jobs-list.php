                                        ...
                                        <div class="d-flex flex-wrap gap-2">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a class="dropdown-item" href="#">Posted Date</a></li>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="ms-2">
                                                                    <p class="fw-semibold mb-0 d-flex align-items-center"><a href="<?php echo base_url('job-details'); ?>"> HTML Developer - Fresher</a></p>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="ms-2">
                                                                    <p class="fw-semibold mb-0 d-flex align-items-center"><a href="<?php echo base_url('job-details'); ?>"> React Lead Developer</a></p>
                                                                    <p class="fs-12 text-muted mb-0">Remote/Onsite</p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="ms-2">
                                                                    <p class="fw-semibold mb-0 d-flex align-items-center"><a href="<?php echo base_url('job-details'); ?>"> Vuejs Frontend Developer</a></p>
                                                                    <p class="fs-12 text-muted mb-0">Remote/Onsite</p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="ms-2">
                                                                    <p class="fw-semibold mb-0 d-flex align-items-center"><a href="<?php echo base_url('job-details'); ?>"> Wordpress Developer - Remote</a></p>
                                                                    <p class="fs-12 text-muted mb-0">Remote/Onsite</p>
                                                                </div>
                                                            </div>
                                                        </td>
