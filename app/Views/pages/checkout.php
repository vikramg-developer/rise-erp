                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                            ...
                                                            <div class="col-xl-6">
                                                                <div class="form-check shipping-method-container mb-0">
                                                                    ...
                                                                    <div class="d-sm-flex align-items-center justify-content-between">
                                                                        <div class="me-2">
                                                                            <span class="avatar avatar-md">
                                                                                <img src="<?php echo base_url('assets/images/ecommerce/png/31.png'); ?>" alt="">
                                                                            </span>
                                                                        </div>
                                                                        <div class="shipping-partner-details me-sm-5 me-0">
                                                            ...
                                                            <div class="col-xl-6">
                                                                <div class="form-check shipping-method-container mb-0">
                                                                    ...
                                                                    <div class="d-sm-flex align-items-center justify-content-between">
                                                                        <div class="me-2">
                                                                            <span class="avatar avatar-md">
                                                                                <img src="<?php echo base_url('assets/images/ecommerce/png/30.png'); ?>" alt="">
                                                                            </span>
                                                                        </div>
                                                                        <div class="shipping-partner-details me-sm-5 me-0">
                                                ...
                                                <div class="tab-pane fade border-0 p-0" id="delivery-tab-pane" role="tabpanel"
                                                    ...
                                                    <div class="p-5 checkout-payment-success my-3">
                                                        ...
                                                        <a href="<?php echo base_url('products'); ?>" class="btn btn-success">Continue Shopping<i class="bi bi-cart ms-2"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
