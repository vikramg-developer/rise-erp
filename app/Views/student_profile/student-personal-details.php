    ...
    <div class="p-4">
        ...
        <form id="student-personalinfo-form">
            <div class="row gy-4">
                ...
                <div class="col-xl-4">
                    ...
                    <select class="form-control" name="student_bloodgroup_id"id="student_bloodgroup_id" >
                        ...
                        <?php foreach ($blood_group as $bg): ?>
                            <option value="<?= esc($bg['blood_group_id']) ?>"
                            <?=
                            (!empty($student_personalinfo_data['student_bloodgroup_id']) && $student_personalinfo_data['student_bloodgroup_id'] == $bg['blood_group_id']) ? 'selected' : ''
                            ?>>
                                        <?= esc($bg['blood_group_name']) ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="col-xl-4">
                    <label class="form-label">
                        <?= lang('App.date'); ?> <?= lang('App.of'); ?> <?= lang('App.birth'); ?>
                ...
                <div class="col-xl-4">
                    ...
                    <select class="form-control" name="student_religion_id" id="student_religion_id">
                        ...
                        <?php foreach ($religion as $rel): ?>
                            <option value="<?= esc($rel['religion_id']) ?>"
                            <?=
                            (!empty($student_personalinfo_data['student_religion_id']) && $student_personalinfo_data['student_religion_id'] == $rel['religion_id']) ? 'selected' : ''
                            ?>>
                                        <?= esc($rel['religion_name']) ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="col-xl-4">
                    ...
                    <select class="form-control" name="student_category_id" id="student_category_id">
                        ...
                        <?php foreach ($caste_category as $category): ?>
                            <option value="<?= esc($category['caste_category_id']) ?>"
                            <?=
                            (!empty($student_personalinfo_data['student_category_id']) && $student_personalinfo_data['student_category_id'] == $category['caste_category_id']) ? 'selected' : ''
                            ?>>
                                        <?= esc($category['caste_category_name']) ?>
                            </option>
                        <?php endforeach; ?>
                ...
                <div class="col-xl-4">
                    ...
                    <select class="form-control" name="student_caste_id" id="student_caste_id">
                        ...
                        <?php foreach ($caste as $c): ?>
                            <option value="<?= esc($c['caste_id']) ?>"
                            <?=
                            (!empty($student_personalinfo_data['student_caste_id']) && $student_personalinfo_data['student_caste_id'] == $c['caste_id']) ? 'selected' : ''
                            ?>>
                                        <?= esc($c['caste_name']) ?>
                            </option>
                        <?php endforeach; ?>
                ...
                <div class="col-xl-4">
                    ...
                    <select class="form-control" name="student_nationality" id="student_nationality">
                        <option value="">Select</option>
                        <option value="indian"
                        <?= (!empty($student_personalinfo_data['student_nationality']) && $student_personalinfo_data['student_nationality'] === 'indian') ? 'selected' : ''
                        ?>>
                            Indian
                        </option>
                        <option value="other"
                        <?= (!empty($student_personalinfo_data['student_nationality']) && $student_personalinfo_data['student_nationality'] === 'other') ? 'selected' : ''
                        ?>>
                            Other
                        </option>
                    </select>
                ...
                <div class="col-xl-4">
                    ...
                    <select class="form-control" name="student_marital_status" id="student_marital_status">
                        ...
                        <?= (!empty($student_personalinfo_data['student_marital_status']) && $student_personalinfo_data['student_marital_status'] === 'unmarried') ? 'selected' : ''
                        ?>>
                            Unmarried
                        </option>
                        <option value="married"
                        <?= (!empty($student_personalinfo_data['student_marital_status']) && $student_personalinfo_data['student_marital_status'] === 'married') ? 'selected' : ''
                        ?>>
                            Married
                        </option>
                        <option value="divorced"
                        <?= (!empty($student_personalinfo_data['student_marital_status']) && $student_personalinfo_data['student_marital_status'] === 'divorced') ? 'selected' : ''
                        ?>>
                            Divorced
                        </option>
                        <option value="widowed"
                        <?= (!empty($student_personalinfo_data['student_marital_status']) && $student_personalinfo_data['student_marital_status'] === 'widowed') ? 'selected' : ''
                        ?>>
                            Widowed
                        </option>
                    </select>
                ...
                <div class="col-xl-4">
                    ...
                    <select class="form-control" name="student_minority" id="student_minority">
                        <option value="">Select</option>
                        <option value="yes"
                        <?= (!empty($student_personalinfo_data['student_minority']) && $student_personalinfo_data['student_minority'] === 'yes') ? 'selected' : ''
                        ?>>
                            Yes
                        </option>
                        <option value="no"
                        <?= (!empty($student_personalinfo_data['student_minority']) && $student_personalinfo_data['student_minority'] === 'no') ? 'selected' : ''
                        ?>>
                            No
                        </option>
                    </select>
                ...
                <div class="col-xl-4">
                    <label class="form-label">
                        <?= lang('App.physical'); ?> <?= lang('App.handicap'); ?>
                        <span class="text-danger">*</span>
                    </label>

                    <select class="form-control"
                            name="student_physically_handicap"
                            id="student_physically_handicap">
                        <option value="">Select</option>
                        <option value="yes" <?= (!empty($student_personalinfo_data['student_physically_handicap']) && $student_personalinfo_data['student_physically_handicap'] === 'yes') ? 'selected' : '' ?>>
                            Yes
                        </option>
                        <option value="no" <?= (!empty($student_personalinfo_data['student_physically_handicap']) && $student_personalinfo_data['student_physically_handicap'] === 'no') ? 'selected' : '' ?>>
                            No
                        </option>
                    </select>

                    <small class="text-danger" id="student_physically_handicap_error" style="display:none;"></small>
                </div>

                <!-- Physical Handicap Type -->
                <div class="col-xl-4" id="handicap_type_div" style="display:none;">
                    <label class="form-label">
                        Handicap Type <span class="text-danger">*</span>
                    </label>
