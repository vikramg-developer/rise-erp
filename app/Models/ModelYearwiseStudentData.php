...
/* =====================================================
    ...
    /* =====================================================
       ...
       ===================================================== */
    private function baseQuery(array $filters, string $search = '')
    {
    ...
    /* =====================================================
       ...
       ===================================================== */
    public function getStudentsForTable(
        array $filters,
        int $limit,
        int $offset,
        string $search = ''
    ...
    /* =====================================================
       ...
       ===================================================== */
    public function countStudents(array $filters, string $search = ''): int
    {
        return $this->baseQuery($filters, $search)
            ->countAllResults();
    }
